...
<div class="my-5 px-4">
    <h2 class="text-center h-font fw-bold">Our Rooms</h2>
                        ...
                        <div class="border bg-light p-3 rounded mb-3">
                            ...
                            <div class="d-flex">
                                <div class="me-3">
                                    ...
                                    <input type="number" class="form-control shadow-none" id="date">
                                </div>
                                <div class="">
            ...
            <div class="card mb-4 border-0 shadow">
                <div class="row g-0 p-3 align-items-center">
                    ...
                    <div class="col-md-2 mt-lg-0 mt-md-0 mt-4 text-center">
                        ...
                        <div class="custom-bg">
                            <a href="#" class="btn btn-sm w-100 text-white shadow-none mb-2">Book Now</a>
                        </div>
